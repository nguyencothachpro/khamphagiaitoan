...
problem_maps:{type:"array",minItems:1,maxItems:5,items:{type:"object",additionalProperties:false,properties:{method_title:{type:"string"},method_note:{type:"string"},root:{type:"string"},branches:{type:"array",minItems:1,maxItems:6,items:{type:"object",additionalProperties:false,properties:{label:{type:"string"},expression:{type:"string"}},required:["label","expression"]}},conclusion_label:{type:"string"},conclusion_value:{type:"string"},explanation:{type:"string"}},required:["method_title","method_note","root","branches","conclusion_label","conclusion_value","explanation"]}},map_discovery_steps:{type:"array",minItems:2,maxItems:10,items:{type:"object",additionalProperties:false,properties:{map_index:{type:"integer"},step_title:{type:"string"},teacher_question:{type:"string"},student_goal:{type:"string"},expected_answer:{type:"string"},unlock:{type:"string"},hint:{type:"string"},if_wrong:{type:"string"}},required:["map_index","step_title","teacher_question","student_goal","expected_answer","unlock","hint","if_wrong"]}},concept_maps:{type:"array",minItems:0,maxItems:5,items:{type:"object",additionalProperties:false,properties:{method_title:{type:"string"},method_note:{type:"string"},root:{type:"string"},branches:{type:"array",minItems:1,maxItems:8,items:{type:"object",additionalProperties:false,properties:{label:{type:"string"},expression:{type:"string"}},required:["label","expression"]}},conclusion_label:{type:"string"},conclusion_value:{type:"string"},explanation:{type:"string"}},required:["method_title","method_note","root","branches","conclusion_label","conclusion_value","explanation"]}},concept_map_steps:{type:"array",minItems:0,maxItems:12,items:{type:"object",additionalProperties:false,properties:{map_index:{type:"integer"},step_title:{type:"string"},teacher_question:{type:"string"},student_goal:{type:"string"},expected_answer:{type:"string"},unlock:{type:"string"},hint:{type:"string"},if_wrong:{type:"string"}},required:["map_index","step_title","teacher_question","student_goal","expected_answer","unlock","hint","if_wrong"]}},
